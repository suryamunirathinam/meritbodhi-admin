...
<body onload="startfun()">
            ...
            <div id="navbar" class="websdktest">
                <form class="navbar-form navbar-right" id="meeting_form">
                    <div class="form-group">
                        <input type="text" name="display_name" id="display_name" value="1.9.7#CDN" maxLength="100"
    ...
    <script>
        ...
        function startfun(){
            var name="<?php echo $_SESSION['InstituteName']; ?>";
            var email="<?php echo $_SESSION['Email']; ?>";
            var mid="<?php echo $_SESSION['meetingid']; ?>";
            var mpass="<?php echo $_SESSION['meetingpass']; ?>";

            document.getElementById('display_name').value=name;
            document.getElementById('meeting_email').value=email;
            document.getElementById('meeting_number').value=mid;
            document.getElementById('meeting_pwd').value=mpass;
